#!/usr/bin/env python
# The 'start_router' script calls this script to launch the router qemu instance, bring up v-eth interfaces, and attach them to OVS
...
'-cpu', 'host', '-drive', 'file=/opt/vlt/voltron/img/%s,if=virtio,media=disk,index=1' %(sys.argv[1]), \
...
'-pidfile', '/opt/vlt/voltron/img/pid/%s.pid' %(sys.argv[3])]
